...
"""
This module implements minemeld.ft.csv.CSVFT and minemeld.ft.csv.CSVFTLocal, the Miner node for csv
feeds over HTTP/HTTPS and locally stored files respectively.
"""
...
class CSVFTLocal(basepoller.BasePollerFT):
    ...
    """Implements class for miners of csv stored locally.
    ...
    **Config parameters**
    ...
    Example:
        Example config in YAML::
            ...
            path: https:/opt/feeeds/sslipblacklist.csv
            ignore_regex: '^#'
            fieldnames:
                - indicator
                - port
